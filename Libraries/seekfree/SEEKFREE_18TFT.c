...
//-------------------------------------------------------------------------------------------------------------------
void lcd_displayimage032_2(uint8 *p, uint16 width, uint16 height) 
{
    int i; 
	...
	for(i=0;i<height * width;i++)
    {
		...
		if(temp == 255) lcd_writedata_16bit(WHITE);
		else if(temp == 0) lcd_writedata_16bit(BLACK);
		else if(temp == 2) lcd_writedata_16bit(RED);
		else if(temp == 3) lcd_writedata_16bit(GREEN);
		else if(temp == 4) lcd_writedata_16bit(BLUE);
//		else if(temp == 5) lcd_writedata_16bit(GREEN);
		else lcd_writedata_16bit(RED);
    }
}
...
//  @note      	图像分辨率需要设置在120(高)*160(宽)以下       
//-------------------------------------------------------------------------------------------------------------------
void lcd_displayimage7725_2(uint8 *p, uint16 width, uint16 height) 
{
    int i; 
	...
	for(i=0;i<height * width;i++)
    {
		...
		if(temp == 1) lcd_writedata_16bit(WHITE);
		else if(temp == 0) lcd_writedata_16bit(BLACK);
		else if(temp == 2) lcd_writedata_16bit(RED);
		else if(temp == 3) lcd_writedata_16bit(GREEN);
		else if(temp == 4) lcd_writedata_16bit(BLUE);
		else lcd_writedata_16bit(YELLOW);
    }
}
